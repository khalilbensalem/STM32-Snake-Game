...
#include "NucleoImp/Display/ili9341_font.h"
...
/**
 * @brief The function reads data from the screens internal memory.
 * @param lcd The handle to the lcd metadata.
 * @param x0 The x position upper left corner of the rectangle of the screen that is going to be read.
 * @param y0 The y position of the upper left corner
